...
public:
    ...
    std::map<std::string, Eigen::Vector2d> relative_coordinates;
    std::map<std::string, Eigen::Vector2d> getRelativeCoordinates() const;
...
private:
    ...
    void printRelativeCoordinates() const;
